...
--
-- Name: lessons Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable insert for authenticated users only" ON "public"."lessons" FOR INSERT TO "authenticated" WITH CHECK (true);


--
-- Name: lessons Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON "public"."lessons" FOR SELECT USING ((("auth"."uid"() = "user_id") OR ("public" = true)));


--
-- Name: lessons Enable update for users based on user_id; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable update for users based on user_id" ON "public"."lessons" FOR UPDATE USING (("auth"."uid"() = "user_id"));


--
-- Name: customers access own ; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "access own " ON "public"."customers" FOR SELECT USING (("auth"."uid"() = "id"));
